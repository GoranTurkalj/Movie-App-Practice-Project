  ...
  <section id="homepage">
    ...
    <transition name="fade" mode="out-in">
      <general-info v-if="!getResultsList.length">
        ...
        <p style="white-space: pre-wrap" slot="info-tip-2" v-show="!getUser.name">To use the watchlist, just <router-link to="/signin">sign-in</router-link> to your account!<br />If you don't have an account, create one by <router-link to="/signup">signing-up</router-link> now.
        </p>
      </general-info>
